  ...
  <div style="max-width:800px;margin:0 auto">
    ...
    <div style="margin-top:32px;background:linear-gradient(135deg,#0f0f14 0%,#1e3a5f 100%);border-radius:16px;padding:32px 36px;display:flex;align-items:center;gap:28px;flex-wrap:wrap">
      ...
      <div style="flex:1;min-width:220px">
        <div style="font-family:Syne;font-weight:800;font-size:18px;color:#fff;margin-bottom:6px">Download E-Book Ekspor Impor — GRATIS</div>
        <div style="font-size:14px;color:rgba(255,255,255,0.65);line-height:1.6">Panduan lengkap ekspor-impor untuk pemula & UMKM. Ditulis oleh tim expert M2B dari pengalaman 5+ tahun lapangan.</div>
      </div>
