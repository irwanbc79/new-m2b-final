...
<section x-data="{
    ...
    submitB2bForm() {
      if (!this.inquiryName || !this.inquiryCompany || !this.inquiryNpwp || !this.inquiryEmail || !this.inquiryPhone || !this.inquiryVolume) {
        alert(this.$store.lang.t('Mohon lengkapi semua kolom wajib!', 'Please fill in all required fields!', '请填写所有必填字段！', 'يرجى melء جميع الحقول المطلوبة!'));
        return;
      }
  ...
  {{-- B2B Cargo & Customs Inquiry Modal --}}
    ...
    <div @click.stop 
      ...
      <div x-show="inquiryStep === 'policy'" style="padding:32px;display:flex;flex-direction:column;gap:20px">
        ...
        <div style="display:flex;flex-direction:column;gap:12px">
          ...
          <label @click="inquiryService = 'free_ship'" 
            ...
            <input type="radio" name="inquiry_service_type" value="free_ship" :checked="inquiryService === 'free_ship'" style="margin-top:4px;accent-color:#4a9eda" />
            <div>
          ...
          <label @click="inquiryService = 'paid'" 
            ...
            style="border:1.5px solid;border-radius:14px;padding:16px 20px;cursor:pointer;display:flex;align-items:start;gap:14px;transition:all 0.2s">
            <input type="radio" name="inquiry_service_type" value="paid" :checked="inquiryService === 'paid'" style="margin-top:4px;accent-color:#4a9eda" />
            <div>
      ...
      <div x-show="inquiryStep === 'form'" style="padding:24px 32px 32px 32px;display:flex;flex-direction:column;gap:18px">
        ...
        <button @click="submitB2bForm()" :disabled="inquiryLoading"
          ...
          <span x-text="inquiryLoading ? $store.lang.t('Mengirim Data...', 'Submitting...', '正在提交...', 'جاري التقديم...') : $store.lang.t('Kirim Inquiry & Dokumen →', 'Submit Inquiry & Documents →', '提交询盘与单证 →', 'تقديم الاستفسar والمستندات ←')"></span>
        </button>
      </div>
